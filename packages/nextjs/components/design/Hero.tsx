...
const Hero = () => {
  return (
    <section className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] bg-gray-50">
      ...
      {/* Subtitle */}
      <p className="md:text-2xl text-sm text-gray-600 mb-8 text-center max-w-2xl">
      ...
      <div className="space-x-4">
        <Link
          href="/marketplace"
          className="md:px-6 px-4 py-3 md:py-4 text-white bg-gray-900 rounded hover:bg-gray-800"
        >
          Explore Marketplace
        </Link>
        <button className="md:px-6 px-4 py-4 md:py-3 text-gray-900 border border-gray-300 rounded hover:bg-gray-100">
          List Your Hardware
        </button>
      </div>
    </section>
